...
public class DataViewGridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    private int spanCount;
    private int spacing;
    private boolean includeEdge;

    public DataViewGridSpacingItemDecoration(int spanCount, int spacing, boolean includeEdge) {
